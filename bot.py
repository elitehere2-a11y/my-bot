...
OWNER_IDS = [8904369672]
ADMINS_FILE = "admin_ids.json"
GROUPS_FILE = "monitored_groups.json"
SUDO_FILE = "sudo.json"
UNAUTHORIZED_MESSAGE = "𝐁ɪɴᴀ 𝐄ʟɪᴛᴇ 𝐁ᴀᴀᴘ 𝐊 𝐏ᴇʀᴍɪꜱꜱɪᴏɴ 𝐊 𝐂ᴏᴍᴍᴀɴᴅ 𝐊ᴇꜱᴇ 𝐔ꜱᴇ 𝐊ᴀʀᴀ 𝐑ɴᴅʏᴋᴇ 𝐁ᴀᴄᴄʜᴇ ~😡🖕"
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🚀 𝐄𝐋𝐈𝐓𝐄 𝐃𝐀𝐃𝐃𝐘 𝐌𝐔𝐋𝐓𝐈-𝐁𝐎𝐓 𝐋𝐎𝐀𝐃𝐄𝐃!\n𝐔𝐬𝐞 /𝐡𝐞𝐥𝐩 𝐟𝐨𝐫 𝐚𝐥𝐥 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬.")

@only_sudo
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = """╭━━━〔 💀𝐄ʟɪᴛᴇ 𝐁ʜᴀɢᴡᴀɴ💀 〕━━━╮
        ✦ 𝐄ʟɪᴛᴇ 𝐁ᴏᴛ 𝐕𝟐 ✦
╰━━━━━━━━━━━━━━━━━━━━━━╯
...
async def threads_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if 1 <= val <= MAX_THREADS:
            ...
            if val > 250:
                await update.message.reply_text("𝐀𝐁𝐁 𝐇𝐀𝐓𝐄𝐑 𝐊𝐈 𝐂𝐇𝐔𝐃𝐀𝐈 𝟗𝟗𝟗𝐊𝐌 𝐊𝐄 𝐑𝐀𝐅𝐓𝐀𝐀𝐑 𝐒𝐄 𝐇𝐎𝐆𝐈 ~ 𝐄𝐋𝐈𝐓𝐄 𝐏𝐀𝐏𝐀 𝐆𝐎𝐃 𝐇𝐀𝐈 !!")
...
async def owner_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("@areyouocybaccha / @ihuntgods 𝐏𝐀𝐏𝐀 𝐉𝐈 𝐎𝐖𝐍𝐄𝐑 𝐇𝐀𝐈 𝐌𝐄𝐑𝐄 ~ 💋👑\n𝐆𝐎𝐃 𝐄𝐋𝐈𝐓𝐄 ~ 😍👑")
...
async def adminbyp_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not context.args or (context.args[0] != "𝐄𝐋𝐈𝐓𝐄 𝐗𝐃𝐘𝐍𝐎" and context.args[0] != "AMANXDYNO"):
        return
