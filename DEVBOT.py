...
# [TOKENS]
TOKENS = [
    "8342415860:AAGT57zLRbQDbSfiI_pbpoAcwqE8a6HE1T8I",
"8900266773:AAFTUXmmTFMQEx89nVLOFtaSeBU76XV-HI0",
"8776572648:AAGTKySpxri8omMBX0PGcQzvQJTwVKqFmRY",
"8783595258:AAEejKGdgm5vAP7qHGBymQNWnMyuzNlUgyA",
"8810880300:AAEsvwxd_kYzjNecHDmDdOdKN_OFzNW-QYs",
"8674578982:AAFZDMFRCXvmyZM2jCGA9WFqSObKHqZ2vFE",
"8840815873:AAFvNY1kQzaQqMwYcB43LWeIZdpMO4RV9fo",
"8647968912:AAHNcAS6SDB2GFMQ_FLd03MrLLTTrdGbVkU",
"8837676766:AAE-KdxWgwVwIPNMj0ELlUrjM6iDQPVJ2SM",
#"8388536692:AAH4iGZfxp9Aoey1YoAnRBU1Jh6qXqoAp2o",
#"8195266337:AAGapJQCXXHO0-FSjC-CYh7PpzkBmlhGytg",
#"8225449143:AAHWpsOqQBtQ8GaxMfM9Eb0e9Y-RARuRBz8",
#"8573474413:AAGcZxqS-AdyNOwX7JElEAJxO2NCngssbfw",
#"8597976440:AAFzct6J3kqd9hCnkZgwbM9yo9v2R0Ebs0o",
#"8384940977:AAHe4oFJ6bCkOjFt9UOzHc3-nCj9NaQibII",
#"8568889638:AAFMImde4SdVv7GB6ec80zctM4l6RHiwXcY",
#"8532826121:AAFNiOrBArljyhjH7fw17CX_ZCx5vLkgDa0",
#"#8046504118:AAGGQ9pDpCtng8bvVXTuFZCtulQDeIhD_Ps",
#"8372890555:AAFILT6g36MMaI0EQXQjWMOzHr3OI-FU9-Q",
#"8265551316:AAG_u1UdjM_JG_QTA7ZtATBckHdyD92cu2c",
...
RAID_TEXTS = [
    ...
    "𝙏𝙍𝙔 𝙈𝘼 𝙆𝙊 𝙀𝙇𝙄𝙏𝙀  𝘼𝘽𝘽𝙐 𝙋𝙀𝙇𝙀", "𝘾𝙃𝙐𝘿𝙂𝙀𝙂𝘼 𝙎𝘼𝘼𝙇 𝘽𝙃𝙍 𝙏𝙐𝙏𝙊 𝘽𝙀𝙏𝘼 🍑"
    "𝙔𝙀𝙃 𝙂𝙍𝙀𝙀𝙑 𝙁𝙔𝙏𝙀𝙍 𝙄𝙎𝙆𝙄 𝙈𝙆𝘽", "𝙃𝙑𝘼𝘽𝘼𝘼𝙕 𝘽𝘼𝙉𝙀𝙂𝘼 𝙏𝙈𝙍",
    "𝙅𝙇𝘿𝙄 𝙅𝙇𝘿𝙄 𝘾𝙃𝙐𝘿 𝙀𝙇𝙄𝙏𝙀  𝘼𝘽𝘽𝙐 𝘽𝙐𝙎𝙎𝙔 𝙃𝘼𝙄", "𝘾𝙑𝙍 𝙆𝙍 𝙈𝘼𝙅𝘽𝙐𝙍𝙄𝙔𝘼 𝙉𝘼 𝙎𝙐𝙉𝘼",
    "𝙏𝙀𝙍𝙄 𝙈𝘼 𝙆𝘼 𝙋𝘼𝙏𝙄 𝙀𝙇𝙄𝙏𝙀  𝙃𝘼𝙄", "𝘽𝙃𝘼𝘼𝙂 𝙈𝘼𝙏 𝙋𝙄𝙇𝙇𝙀 𝙊𝙔𝙀",
    "𝘼𝘽𝙀 𝙇𝙊𝘿𝙐 𝙏𝙀𝙍𝙄 𝙂𝘼𝙉𝘿 𝙈𝙀 𝘿𝘼𝙉𝘿𝘼", "𝙀𝙇𝙄𝙏𝙀  𝙊𝙉 𝙏𝙊𝙋 𝘽𝘼𝘽𝙔",
    "𝙏𝙀𝙍𝙄 𝙈𝘼 𝙆𝙄 𝘾𝙃𝙐𝙏 𝙈𝙀 𝘽𝙊𝙏 𝙆𝘼 𝙇𝙐𝙉𝘿", "𝘽𝙃𝘼𝂂 𝘽𝙃𝙊𝙎𝘿𝙄𝙆𝙀 𝘽𝙃𝘼𝂂",
    "𝘼𝙋𝙉𝙄 𝘼𝙈𝙈𝙄 𝙆𝙊 𝘽𝙃𝙀𝙅 𝙋𝘼𝙉𝙄 𝙉𝙄𝙆𝘼𝙇𝙉𝘼 𝙃", "𝙏𝙀𝙍𝘼 𝙆𝙃𝘼𝙉𝘿𝘼𝙉 𝙆𝙃𝘼𝙏𝘼𝙈",
    "𝙀𝙇𝙄𝙏𝙀  𝙆𝙄 𝘿𝙀𝙃𝙎𝙃𝘼𝙏", "𝘽𝘼𝘼𝙋 𝙎𝙀 𝘽𝘼𝙆𝘾𝙃𝙊𝘿𝙄 𝙉𝙃𝙄",
    ...
    "     𝐊ʏᴜ 𝐑ᴇ 𝐑ᴀɴᴅɪ 𝐌𝐀 ᴋᴇ 𝐋ᴀᴅᴄᴏ 𝙀𝙇𝙄𝙏𝙀  ᴀʙʙᴜ 𝐊ᴏ 𝐃ʙᴀ. ɴʜɪ 𝐏ᴀʀᴇ ᴄʏᴀ??🤬",
    "     𝐊ʏᴜ 𝐑ᴇ 𝐑ᴀɴᴅɪ 𝐌𝐀 ᴋᴇ 𝐋ᴀᴅᴄᴏ 𝙀𝙇𝙄𝙏𝙀  ᴀʙʙᴜ 𝐊ᴏ 𝐃ʙᴀ. ɴʜɪ 𝐏ᴀʀᴇ ᴄʏᴀ??😡",
    "     𝐊ʏᴜ 𝐑ᴇ 𝐑ᴀɴᴅɪ 𝐌𝐀 ᴋᴇ 𝐋ᴀᴅᴄᴏ 𝙀𝙇𝙄𝙏𝙀  ᴀʙʙᴜ 𝐊ᴏ 𝐃ʙᴀ. ɴʜɪ 𝐏ᴀʀᴇ ᴄʏᴀ??🤨",
    "     𝐊ʏᴜ 𝐑ᴇ 𝐑ᴀɴᴅɪ 𝐌𝐀 ᴋᴇ 𝐋ᴀᴅᴄᴏ 𝙀𝙇𝙄𝙏𝙀  ᴀʙʙᴜ 𝐊ᴏ 𝐃ʙᴀ. ɴʜɪ 𝐏ᴀʀᴇ ᴄʏᴀ??😱",
    "     𝐊ʏᴜ 𝐑ᴇ 𝐑ᴀɴᴅɪ 𝐌𝐀 ᴋᴇ 𝐋ᴀᴅᴄᴏ 𝙀𝙇𝙄𝙏𝙀  ᴀʙʙᴜ 𝐊ᴏ 𝐃ʙᴀ. ɴʜɪ 𝐏ᴀʀᴇ ᴄʏᴀ??😮‍💨",
